            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                    <div class="footer-widget__latest-post">
                        <h4 class="footer-widget__tag">About Us</h4>
                        <p class="text-white footer-widget__text">Empowering financial success, we
                            <br>are trusted ally in navigating the 
                            <br>complexities of money 
                            <br>management, offering insightful 
                            <br>guidance and innovative solutions 
                            <br>for a secure and prosperous future.</p>
                    </div>
                </div>
                <div class="col-xl-2 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                    <div class="footer-widget__services">
                        <h4 class="footer-widget__tag">Useful Links</h4>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                    <div class="footer-widget__contact">
                        <h4 class="footer-widget__tag">Contact Info</h4>
                        <ul class="footer-widget__contact-box list-unstyled">
                            <li>
                                ...
                                <div class="text">
                                    <p><a href="mailto:helpus24@gmail.com" class="text-white">
                                        helpus24@gmail.com</a></p>
                                </div>
                            </li>
                            <li>
                                <div class="icon">
                                ...
                                <div class="text">
                                    <p><a href="tel:0881122334455" class="text-white">
                                        +088 11 22 33 44 55</a></p>
                                </div>
                            </li>
                        </ul>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="site-footer__bottom-inner justify-content-center">
                        <p class="site-footer__bottom-text text-white mb-0">Copyright <i class="fa fa-copyright"></i>
                            <script>
                                document.write(new Date().getFullYear());

                            </script> <a href="https://single-solution.com/" style="text-decoration:underline;color:white">Single Solution</a>. All rights reserved.
                        </p>
                    </div>
                </div>
            </div>
